...
import { Application, Message, RegularOfficeHour, FileItem, ApplicationStatus, Consultant, MessageTemplate, UserWithPermissions, Program, OfficeHourReport, Notification, ChatRoom, ChatMessage, ChatAttachment, AIRecommendation, Goal, TeamMember } from "./lib/types";
...
export function AppContent() {
  ...
  useEffect(() => {
    if (user) {
      if (user.role === "admin" || user.role === "consultant" || user.role === "staff") {
  ...
  return (
    <div className="h-screen flex flex-col">
      <Topbar user={user} onLogout={async () => {
        await authSignOut();
